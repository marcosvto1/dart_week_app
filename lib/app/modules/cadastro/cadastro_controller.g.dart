...
mixin _$CadastroController on _CadastroControllerBase, Store {
  ...
  @override
  ObservableFuture<void> get _cadastraLoginFuture {
  ...
  @override
  set _cadastraLoginFuture(ObservableFuture<void> value) {
  ...
  final _$cadastroLoginSuccessAtom =
      Atom(name: '_CadastroControllerBase.cadastroLoginSuccess');

  @override
  bool get cadastroLoginSuccess {
    _$cadastroLoginSuccessAtom.context
        .enforceReadPolicy(_$cadastroLoginSuccessAtom);
    _$cadastroLoginSuccessAtom.reportObserved();
    return super.cadastroLoginSuccess;
  }

  @override
  set cadastroLoginSuccess(bool value) {
    _$cadastroLoginSuccessAtom.context.conditionallyRunInAction(() {
      super.cadastroLoginSuccess = value;
      _$cadastroLoginSuccessAtom.reportChanged();
    }, _$cadastroLoginSuccessAtom,
        name: '${_$cadastroLoginSuccessAtom.name}_set');
  }
  ...
  String toString() {
    final string =
        'login: ${login.toString()},senha: ${senha.toString()},confirmaSenha: ${confirmaSenha.toString()},errorMessage: ${errorMessage.toString()},cadastroLoginSuccess: ${cadastroLoginSuccess.toString()},state: ${state.toString()}';
    return '{$string}';
  }
}
